...
<table border="1" style="border-collapse: collapse;">
	<tr>
		...
		<?php $no=0; foreach($this->trans->detail_pembelian($transaksi->id_transaksi) as $kaos): $no++; ?>
		<tr>
			<th><?=$no?></th>
			<th><?=$kaos->nama_kaos?></th>
			<th><?= number_format($kaos->harga)?></th>
			<th><?=$kaos->jumlah?></th>
			<th><?= number_format(($kaos->harga*$kaos->jumlah)) ?></th>
		</tr>
	<?php endforeach ?>
		<tr>
