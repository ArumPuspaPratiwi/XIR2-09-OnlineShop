...
<html lang="en">
  <head>
    ...
    <title>ONLINE SHOP | ARUMPIKACHU</title>
  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="<?=base_url('index.php/kaos/dashboard')?>" class="logo"><b>ARUMPIKACHU</b></a>
            <!--logo end-->
                ...
                <ul class="nav top-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended tasks-bar">
                            ...
                            <li>
                                <a href="index.html#">
                                    <div class="task-info">
                                        <div class="desc">Senang sekali!</div>
                    ...
                    <li id="header_inbox_bar" class="dropdown">
                        ...
                        <ul class="dropdown-menu extended inbox">
                            ...
                            <li>
                                <a href="index.html#">
                                    <span class="photo"><img alt="avatar" src="<?=base_url()?>assets/img/ui-ain.jpg"></span>
                                    <span class="subject">
                                    <span class="from">Ain.Kopiko</span>
                                    <span class="time">Sekarang</span>
                                    </span>
                                    <span class="message">
                                        Pesan kaos gucci 2 min, ada g?
                                    </span>
                                </a>
                            </li>
                            <li>
                                <a href="index.html#">
                                    <span class="photo"><img alt="avatar" src="<?=base_url()?>assets/img/hrh.jpg"></span>
                                    <span class="subject">
                                    <span class="from">Salsambr</span>
                                    <span class="time">40 mins.</span>
                                    </span>
                                    <span class="message">
                                     Kaosnya nyaman min, beli lagi min
                                    </span>
                                </a>
                            </li>
                            <li>
                                <a href="index.html#">
                                    <span class="photo"><img alt="avatar" src="<?=base_url()?>assets/img/ui-najong.jpg"></span>
                                    <span class="subject">
                                    <span class="from">Najong</span>
                                    <span class="time">2 hrs.</span>
                                    </span>
                                    <span class="message">
                                        Keren banget min sumpil gak goril
                                    </span>
                                </a>
                            </li>
                            <li>
                                <a href="index.html#">
                                    <span class="photo"><img alt="avatar" src="<?=base_url()?>assets/img/ui-amel.jpg"></span>
                                    <span class="subject">
                                    <span class="from">Ameliaa</span>
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="mt">
                      <a class="active" href="<?=base_url('index.php/kaos/dashboard')?>">
                  ...
                  <li class="sub-menu">
                      <a href="<?=base_url('index.php/kaos/toko')?>" >
                  ...
                  <li class="sub-menu">
                      <a href="javascript:;" >
                          ...
                          <span>Koleksi Kaos</span>
                      </a>
                      <ul class="sub">
                          <li><a  href="<?=base_url('index.php/kaos')?>">Daftar Kaos</a></li>
                  ...
                  <li class="sub-menu">
                    <a href="<?=base_url('index.php/kaos/event')?>" >
                          <i class="fa fa-dashboard"></i>
                          <span>Event</span>
                      </a>
                  </li>
                  <li class="sub-menu">
                    <a href="<?=base_url('index.php/kaos/profil')?>" >
